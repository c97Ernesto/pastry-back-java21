...
public class DataSeeder implements CommandLineRunner {
    ...
    private void seedProducts(Map<String, Category> categories) {
        ...
        createProduct("Pastel de Vainilla Clásico", "Bizcocho esponjoso de vainilla con betún de mantequilla", 2,
        ...
        createProduct("Pastel de Fresas con Crema", "Bizcocho de vainilla con fresas frescas y crema chantilly", 1,
        ...
        createProduct("Cupcake Red Velvet", "Cupcake rojo aterciopelado con queso crema", 1, new BigDecimal("48.00"),
                categories.get("Cupcakes"));
        createProduct("Cupcake de Limón", "Sabor cítrico refrescante con frosting de limón", 1, new BigDecimal("45.00"),
                categories.get("Cupcakes"));
        createProduct("Cupcake de Nutella", "Relleno de Nutella con frosting de avellanas", 1, new BigDecimal("55.00"),
                categories.get("Cupcakes"));
        ...
        createProduct("Galletas de Chispas de Chocolate", "Clásicas con chips de chocolate semi-amargo. Docena", 1,
        ...
        createProduct("Concha de Chocolate", "Concha clásica con costra de chocolate", 0, new BigDecimal("18.00"),
        ...
        createProduct("Oreja", "Pan hojaldrado caramelizado, crujiente y dulce", 0, new BigDecimal("22.00"),
                categories.get("Pan Dulce Mexicano"));
        createProduct("Polvorón Rosa", "Galleta de mantequilla que se deshace en la boca", 0, new BigDecimal("15.00"),
                categories.get("Pan Dulce Mexicano"));
        ...
        createProduct("Pay de Limón", "Relleno cremoso de limón con merengue italiano", 2, new BigDecimal("260.00"),
        ...
        createProduct("Tarta Tatin", "Tarta francesa invertida de manzana caramelizada", 2, new BigDecimal("300.00"),
                categories.get("Tartas y Pays"));
        ...
        createProduct("Mousse de Chocolate", "Mousse sedoso de chocolate belga 70% cacao", 1, new BigDecimal("75.00"),
        ...
        createProduct("Panna Cotta", "Postre italiano de nata con coulis de frutos rojos", 1, new BigDecimal("70.00"),
                categories.get("Postres Individuales"));
        createProduct("Crème Brûlée", "Crema francesa con costra de caramelo crujiente", 1, new BigDecimal("80.00"),
                categories.get("Postres Individuales"));
        createProduct("Profiteroles", "Choux rellenos de crema con chocolate caliente", 1, new BigDecimal("95.00"),
                categories.get("Postres Individuales"));
